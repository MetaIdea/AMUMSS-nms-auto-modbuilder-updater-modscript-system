					...
					{
						{
							...
							["MATH_OPERATION"] 		= "*", 				-- "*", "+", "-", "/" or leave empty for normal replacement, "*F:VALUENAME", "*L:NUMBERLINESFORWARD", "*FB:VALUENAME", "*LB:NUMBERLINESBACKWARD", do math op with values before or after the line
